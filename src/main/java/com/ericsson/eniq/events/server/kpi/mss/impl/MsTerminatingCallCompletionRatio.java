...
public class MsTerminatingCallCompletionRatio implements MssKPI {

	@EJB
	private KpiUtilities kpiUtilities;

	private final static String KPI_NAME = "MS Terminating call completion ratio";
	
	/**
	 * @param kpiUtils
	 */
	public MsTerminatingCallCompletionRatio(final KpiUtilities kpiUtils) {
