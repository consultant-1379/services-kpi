...
public class MsOriginatingCallDropIntensity implements MssKPI {

	@EJB
	private KpiUtilities kpiUtilities;

	private final static String KPI_NAME = "MS Originating call drop intensity";

	/**
	 * @param kpiUtils
	 */
	public MsOriginatingCallDropIntensity(final KpiUtilities kpiUtils) {
