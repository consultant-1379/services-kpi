...
public class TrackingAreaUpdateSuccessRateKPI implements KPI {
     ...
     * @param kpiUtilities
     */
    public TrackingAreaUpdateSuccessRateKPI(final KpiUtilities kpiUtils) {
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        parameters.put(KPI_NAME_VARIABLE, TRACKING_AREA_UPDATE_SUCCESS_RATE);
