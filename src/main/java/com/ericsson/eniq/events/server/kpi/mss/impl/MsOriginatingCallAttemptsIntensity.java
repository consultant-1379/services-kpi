...
public class MsOriginatingCallAttemptsIntensity implements MssKPI {

	@EJB
	private KpiUtilities kpiUtilities;

	private final static String KPI_NAME = "MS Originating call attempts intensity";

	/**
	 * @param kpiUtils
	 */
	public MsOriginatingCallAttemptsIntensity(final KpiUtilities kpiUtils) {
	...
	public Map<String, String> getErrorColumnsAggForBlocked() {
		...
		errorColumns.put(KPIConstants.NO_OF_BLOCKED_CALLS, KPIConstants.NO_OF_ERRORS);
		return errorColumns;
	}
	...
	public Map<String, String> getErrorColumnsRawForBlocked() {
		final Map<String, String> errorColumns = new HashMap<String, String>();
		errorColumns.put(KPIConstants.NO_OF_BLOCKED_CALLS, KPIConstants.NO_OF_ERRORS_RAW);
		return errorColumns;
	}
	...
	throws ResourceInitializationException {
		...
		parameters.put(NO_OF_BLOCKED_CALLS_VAR, KPIConstants.NO_OF_BLOCKED_CALLS);
		...
		final String queryFragment = kpiUtilities.getQueryFromTemplate(KPIConstants.MSS_CALL_ATTEMPTS_INTENSITY_VM,
				parameters);
	...
	public String getEventID() {
		...
		return kpiUtilities.getMssEventID(ApplicationConstants.MS_ORIGINATING);
	}
