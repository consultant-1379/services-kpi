...
public class CallForwardingSuccessRatio implements MssKPI {

        @EJB
        private KpiUtilities kpiUtilities;

        private final static String KPI_NAME = "Call Forwarding Success Ratio";

        /**
         * @param kpiUtils
         */
        public CallForwardingSuccessRatio(final KpiUtilities kpiUtils) {
        ...
        throws ResourceInitializationException {
                ...
                final String queryFragment = kpiUtilities.getQueryFromTemplate(KPIConstants.MSS_CALL_COMPLETION_RATIO_VM,
                                parameters);
        ...
        public String getEventID() {
                ...
                return kpiUtilities.getMssEventID(CALL_FORWARDING);
        }
