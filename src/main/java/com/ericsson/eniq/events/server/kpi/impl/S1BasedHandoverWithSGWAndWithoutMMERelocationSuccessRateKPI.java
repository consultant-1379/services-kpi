...
public class S1BasedHandoverWithSGWAndWithoutMMERelocationSuccessRateKPI implements KPI {
     ...
     * @param kpiUtilities
     */
    public S1BasedHandoverWithSGWAndWithoutMMERelocationSuccessRateKPI(final KpiUtilities kpiUtils) {
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        parameters.put(KPI_NAME_VARIABLE, S1_BASED_HANDOVER_W_SGW_WO_MME_RELOC_SUCCESS_RATIO);
        parameters.put(CONDITION_COLUMN, EVENT_SUBTYPE_ID);
        final String condition = " = 5";
