...
public class MsOriginatingEmergencyCallDropRatio implements MssKPI {

    @EJB
    private KpiUtilities kpiUtilities;

    private final static String KPI_NAME = "MS Originating emergency call drop ratio";

    /**
     * @param kpiUtils
     */
    public MsOriginatingEmergencyCallDropRatio(final KpiUtilities kpiUtils) {
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        final String queryFragment = kpiUtilities.getQueryFromTemplate(KPIConstants.MSS_CALL_DROP_RATIO_VM, parameters);
