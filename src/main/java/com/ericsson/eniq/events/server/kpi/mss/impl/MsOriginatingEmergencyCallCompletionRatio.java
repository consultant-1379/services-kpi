...
public class MsOriginatingEmergencyCallCompletionRatio implements MssKPI {
    @EJB
    private KpiUtilities kpiUtilities;

    private final static String KPI_NAME = "MS Originating Emergency call completion ratio";

    /**
     * @param kpiUtils
     */
    public MsOriginatingEmergencyCallCompletionRatio(final KpiUtilities kpiUtils) {
