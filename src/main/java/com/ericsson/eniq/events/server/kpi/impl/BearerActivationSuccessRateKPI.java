...
public class BearerActivationSuccessRateKPI implements KPI {
     ...
     * @param kpiUtilities
     */
    public BearerActivationSuccessRateKPI(final KpiUtilities kpiUtils) {
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        parameters.put(KPI_NAME_VARIABLE, BEARER_ACTIVATION_SUCCESS_RATE);

        final String queryFragment = kpiUtilities.getQueryFromTemplate(NETWORK_EVENT_RATE_CALC_VM, parameters);
    ...
    public String getEventID() {
        return kpiUtilities.getEventID(ApplicationConstants.L_DEDICATED_BEARER_ACTIVATE);
    }
