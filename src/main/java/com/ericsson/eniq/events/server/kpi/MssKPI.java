...
public interface MssKPI {
	...
	/**
	 * These are the columns needed from the aggregated blocked tables 
	 * @return A map of strings with the key = alias and value = column name 
	 */
	Map<String, String>  getErrorColumnsAggForBlocked();

	/**
	 * These are the columns needed from the aggregated dropped tables 
	 * @return A map of strings with the key = alias and value = column name 
	 */
	Map<String, String>  getErrorColumnsAggForDropped();

	/**
	 * These are the columns needed from the raw error tables 
	 * @return A map of strings with the key = alias and value = column name 
	 */
	Map<String, String> getErrorColumnsRawForDropped();

	/**
	 * These are the columns needed from the raw error tables 
	 * @return A map of strings with the key = alias and value = column name 
	 */
	Map<String, String> getErrorColumnsRawForBlocked();
