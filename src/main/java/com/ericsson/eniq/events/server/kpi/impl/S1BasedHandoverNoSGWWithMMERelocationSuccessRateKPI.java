...
public class S1BasedHandoverNoSGWWithMMERelocationSuccessRateKPI implements KPI {
     ...
     * @param kpiUtilities
     */
    public S1BasedHandoverNoSGWWithMMERelocationSuccessRateKPI(final KpiUtilities kpiUtils) {
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        parameters.put(KPI_NAME_VARIABLE, S1_BASED_HANDOVER_WO_SGW_W_MME_RELOC_SUCCESS_RATIO);
        parameters.put(CONDITION_COLUMN, EVENT_SUBTYPE_ID);
        final String condition = " = 6";
