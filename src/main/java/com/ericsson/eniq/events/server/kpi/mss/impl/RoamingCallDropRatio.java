...
public class RoamingCallDropRatio implements MssKPI {

        @EJB
        private KpiUtilities kpiUtilities;

        private final static String KPI_NAME = "Roaming Call drop ratio";

        /**
         * @param kpiUtils
         */
        public RoamingCallDropRatio(final KpiUtilities kpiUtils) {
