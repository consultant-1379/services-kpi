...
public class S1BasedHandoverSuccessRateKPI implements KPI {
     ...
     * @param kpiUtilities
     */
    public S1BasedHandoverSuccessRateKPI(final KpiUtilities kpiUtils) {
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        parameters.put(KPI_NAME_VARIABLE, S1_BASED_HANDOVER_SUCCESS_RATIO);
        parameters.put(CONDITION_COLUMN, EVENT_SUBTYPE_ID);
        final String condition = " = 7";
