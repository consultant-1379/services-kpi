...
public class SmsOriginatingSuccessRatio implements MssKPI {

    @EJB
    private KpiUtilities kpiUtilities;

    private final static String KPI_NAME = "Sms Originating Success Ratio";

    /**
     * @param kpiUtils
     */
    public SmsOriginatingSuccessRatio(final KpiUtilities kpiUtils) {
    ...
    public String getEventID() {
        ...
        return kpiUtilities.getMssEventID(MS_ORIGINATING_SMS_MSC);
    }
