...
public class S1BasedHandoverWithSGWAndWithMMERelocationSuccessRateKPI implements KPI {
     ...
     * @param kpiUtilities
     */
    public S1BasedHandoverWithSGWAndWithMMERelocationSuccessRateKPI(final KpiUtilities kpiUtils) {
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        parameters.put(KPI_NAME_VARIABLE, S1_BASED_HANDOVER_W_SGW_W_MME_SUCCESS_RATIO);
        parameters.put(CONDITION_COLUMN, EVENT_SUBTYPE_ID);
        final String condition = " = 3";
