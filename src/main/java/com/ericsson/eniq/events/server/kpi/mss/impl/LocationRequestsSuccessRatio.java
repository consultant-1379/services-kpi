...
public class LocationRequestsSuccessRatio implements MssKPI {

    @EJB
    private KpiUtilities kpiUtilities;

    private final static String KPI_NAME = "Location Request Success Ratio";

    /**
     * @param kpiUtils
     */
    public LocationRequestsSuccessRatio(final KpiUtilities kpiUtils) {
    ...
    public Map<String, String> getErrorColumnsAggForBlocked() {
        ...
        errorColumns.put(KPIConstants.NO_OF_ERRORS, KPIConstants.NO_OF_ERRORS);
        return errorColumns;
    }
    ...
    public Map<String, String> getErrorColumnsRawForBlocked() {
        final Map<String, String> errorColumns = new HashMap<String, String>();
        errorColumns.put(KPIConstants.NO_OF_ERRORS, KPIConstants.NO_OF_ERRORS_RAW);
        return errorColumns;
    }
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        parameters.put(KPIConstants.NO_OF_ERRORS_VARIABLE, KPIConstants.NO_OF_ERRORS);
        parameters.put(KPIConstants.KPI_NAME_VARIABLE, KPI_NAME);
        final String queryFragment = kpiUtilities.getQueryFromTemplate(
                KPIConstants.MSS_CALL_COMPLETION_RATIO_SMS_LOC_SERVICE_VM, parameters);
    ...
    public String getEventID() {
        ...
        return kpiUtilities.getMssEventID(LOCATION_SERVICES);
    }
