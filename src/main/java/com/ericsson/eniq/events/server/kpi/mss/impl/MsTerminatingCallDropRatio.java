...
public class MsTerminatingCallDropRatio implements MssKPI {

	@EJB
	private KpiUtilities kpiUtilities;

	private final static String KPI_NAME = "MS Terminating call drop ratio";

	/**
	 * @param kpiUtils
	 */
	public MsTerminatingCallDropRatio(final KpiUtilities kpiUtils) {
