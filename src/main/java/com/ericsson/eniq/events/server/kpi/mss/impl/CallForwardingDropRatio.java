...
public class CallForwardingDropRatio implements MssKPI {

        @EJB
        private KpiUtilities kpiUtilities;

        private final static String KPI_NAME = "Call Forwarding drop ratio";

        /**
         * @param kpiUtils
         */
        public CallForwardingDropRatio(final KpiUtilities kpiUtils) {
