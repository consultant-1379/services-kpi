...
public class X2BasedHandoverSuccessRateKPI implements KPI {
     ...
     * @param kpiUtilities
     */
    public X2BasedHandoverSuccessRateKPI(final KpiUtilities kpiUtils) {
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        parameters.put(KPI_NAME_VARIABLE, X2_BASED_HANDOVER_SUCCESS_RATIO);
