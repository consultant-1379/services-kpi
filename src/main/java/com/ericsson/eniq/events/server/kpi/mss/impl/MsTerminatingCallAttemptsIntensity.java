...
public class MsTerminatingCallAttemptsIntensity implements MssKPI {

	@EJB
	private KpiUtilities kpiUtilities;

	private final static String KPI_NAME = "MS Terminating call attempts intensity";

	/**
	 * @param kpiUtils
	 */
	public MsTerminatingCallAttemptsIntensity(final KpiUtilities kpiUtils) {
