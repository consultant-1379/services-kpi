...
public class InterTrackingAreaUpdateSuccessRateKPI implements KPI {
     ...
     * @param kpiUtilities
     */
    public InterTrackingAreaUpdateSuccessRateKPI(final KpiUtilities kpiUtils) {
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        parameters.put(KPI_NAME_VARIABLE, INTER_MME_TAU_SUCCESS_RATE);
