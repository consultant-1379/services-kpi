...
public class MsOriginatingCallCompletionRatio implements MssKPI {

	@EJB
	private KpiUtilities kpiUtilities;

	private final static String KPI_NAME = "MS Originating call completion ratio";

	/**
	 * @param kpiUtils
	 */
	public MsOriginatingCallCompletionRatio(final KpiUtilities kpiUtils) {
