...
public class SmsTerminatingSuccessRatio implements MssKPI {

    @EJB
    private KpiUtilities kpiUtilities;

    private final static String KPI_NAME = "Sms Terminating Success Ratio";

    /**
     * @param kpiUtils
     */
    public SmsTerminatingSuccessRatio(final KpiUtilities kpiUtils) {
    ...
    public String getEventID() {
        ...
        return kpiUtilities.getMssEventID(MS_TERMINATING_SMS_MSC);
    }
