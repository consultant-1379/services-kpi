...
public class X2BasedHandoverWithoutSGWRelocationSuccessRateKPI implements KPI {
     ...
     * @param kpiUtilities
     */
    public X2BasedHandoverWithoutSGWRelocationSuccessRateKPI(final KpiUtilities kpiUtils) {
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        parameters.put(KPI_NAME_VARIABLE, X2_BASED_HO_WITHOUT_SQW_RELOCATION_SUCCESS_RATIO);
