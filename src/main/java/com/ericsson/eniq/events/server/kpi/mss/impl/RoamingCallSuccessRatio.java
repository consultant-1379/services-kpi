...
public class RoamingCallSuccessRatio implements MssKPI {

        @EJB
        private KpiUtilities kpiUtilities;

        private final static String KPI_NAME = "Roaming Call Success Ratio";

        /**
         * @param kpiUtils
         */
        public RoamingCallSuccessRatio(final KpiUtilities kpiUtils) {
        ...
        public String getEventID() {
                ...
                return kpiUtilities.getMssEventID(ROAMING_CALL_FORWARDING);
        }
