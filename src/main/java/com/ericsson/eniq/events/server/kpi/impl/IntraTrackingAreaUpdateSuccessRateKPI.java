...
public class IntraTrackingAreaUpdateSuccessRateKPI implements KPI {
     ...
     * @param kpiUtilities 
     */
    public IntraTrackingAreaUpdateSuccessRateKPI(final KpiUtilities kpiUtils) {
    ...
    public String getKPICalculation(final Map<String, Object> parameters) throws ResourceInitializationException {
        ...
        parameters.put(KPI_NAME_VARIABLE, INTRA_MME_TAU_SUCCESS_RATE);
