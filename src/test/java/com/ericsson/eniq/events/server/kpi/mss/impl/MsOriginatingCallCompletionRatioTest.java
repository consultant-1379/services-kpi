...
public class MsOriginatingCallCompletionRatioTest extends KPIBaseTestClass {

	
	 private MsOriginatingCallCompletionRatio objUnderTest;

	    @Before
	    public void onSetUp(){
	        objUnderTest = new MsOriginatingCallCompletionRatio(this.kpiUtilities);
