...
public class MsOriginatingCallAttemptsIntensityTest extends KPIBaseTestClass {
	
	 private MsOriginatingCallAttemptsIntensity objUnderTest;

	    @Before
	    public void onSetUp(){
	        objUnderTest = new MsOriginatingCallAttemptsIntensity(this.kpiUtilities);
