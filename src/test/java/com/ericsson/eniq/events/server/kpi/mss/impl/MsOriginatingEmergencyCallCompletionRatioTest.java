...
public class MsOriginatingEmergencyCallCompletionRatioTest extends KPIBaseTestClass {


	
	 private MsOriginatingEmergencyCallCompletionRatio objUnderTest;

	    @Before
	    public void onSetUp(){
	        objUnderTest = new MsOriginatingEmergencyCallCompletionRatio(this.kpiUtilities);
