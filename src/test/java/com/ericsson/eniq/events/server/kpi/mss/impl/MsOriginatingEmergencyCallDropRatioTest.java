...
public class MsOriginatingEmergencyCallDropRatioTest extends KPIBaseTestClass {


	
	 private MsOriginatingEmergencyCallDropRatio objUnderTest;

	    @Before
	    public void onSetUp(){
	        objUnderTest = new MsOriginatingEmergencyCallDropRatio(this.kpiUtilities);
