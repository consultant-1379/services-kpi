...
public class MsTerminatingCallDropIntensityTest extends KPIBaseTestClass {

	private MsTerminatingCallDropIntensity objUnderTest;

	@Before
	public void onSetUp(){
		objUnderTest = new MsTerminatingCallDropIntensity(this.kpiUtilities);
