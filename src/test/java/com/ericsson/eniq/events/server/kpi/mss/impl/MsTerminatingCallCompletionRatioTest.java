...
public class MsTerminatingCallCompletionRatioTest extends KPIBaseTestClass {

	private MsTerminatingCallCompletionRatio objUnderTest;

	@Before
	public void onSetUp(){
		objUnderTest = new MsTerminatingCallCompletionRatio(this.kpiUtilities);
