...
public class MsOriginatingCallDropRatioTest extends KPIBaseTestClass {
	
	 private MsOriginatingCallDropRatio objUnderTest;

	    @Before
	    public void onSetUp(){
	        objUnderTest = new MsOriginatingCallDropRatio(this.kpiUtilities);
