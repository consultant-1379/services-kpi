...
public class MsTerminatingCallDropRatioTest extends KPIBaseTestClass {

	private MsTerminatingCallDropRatio objUnderTest;

	@Before
	public void onSetUp(){
		objUnderTest = new MsTerminatingCallDropRatio(this.kpiUtilities);
